        ...
        <ul>
            <% if (session.getAttribute("uname") != null) { %>
                ...
                <% if ("1".equals(session.getAttribute("id"))) { %>
                    ...
                    <li><a href="BookedProducts.jsp">BookedProducts</a></li>
                    <li><a href="UserReviews.jsp">UserReviews</a></li>
                    <li><a href="AppList.jsp">AppointmentList</a></li>
                <% } else { %>
                 
                    <li><a href="HealthAssist.jsp">HealthAssistance</a></li>
                <% } %>
